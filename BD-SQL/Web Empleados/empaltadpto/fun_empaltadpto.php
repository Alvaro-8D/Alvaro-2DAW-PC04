...
/*********************** VOY POR INSERTAR PRODUCTO********************************************* */
// NOTA IMPORTANTE ----> TENGO QUE INLUIR COMMIT; ROLLBACK; Y CAPTAR LOS ERRORES
    ...
    function ultimo_id($consulta){
        ...
        if($resultado[0]["ultimo_id"] == null){
            ...
            $nuevoID = "D".str_pad($resultado[0]["ultimo_id"],4,0,STR_PAD_LEFT); 
        }
        $consulta = null;
        return $nuevoID;
    }

    function insertar_producto($consulta,$nombre,$nuevoID){ 
