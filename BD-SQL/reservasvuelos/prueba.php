...
<?php
	...
	$order = time();
	$amount = "1212"; // precio a pagar (se pone en * céntimos *)
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
			$amount = limpiar_campos("".(100*(double)$_POST["precio"])); // * 100 para que sea en centimos
			$descripcion = limpiar_campos($_POST["desc"]);
		}
?>
