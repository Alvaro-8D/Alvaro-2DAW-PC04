<?php
	function generar_peticion_pago(){
		...
		$order = time();
		$amount = "108201"; // precio a pagar (se pone en * céntimos *)
		$descripcion = "Figurita de All Might"; // descripción de la compra (125 caracteres / A-N)
